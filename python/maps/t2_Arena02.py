##"t2_Arena01.py" - A large(r) arena meant for two teams
...
def get_arena(path=""):
    ...
    arena = [
         ...
         [20, 4, 3, 3, 3, 3, 0,11,11, 4, 4, 0, 0, 0, 3,20],
         [20, 4,25, 2, 2,29, 0, 0,29, 4,27,19,19,21, 3,20],
         [20, 0,23,21, 2, 0, 0,29, 0, 4, 0, 0, 1,26, 3,20],
         [20, 0, 0,26, 1,29, 0, 0,29, 4,29, 2, 1, 2, 2,20],
         [20,12,11,10, 1, 0, 0,29, 0, 0, 0, 0,10,11,12,20],
         [20, 4, 4,10,29, 0,29, 0, 0,29, 0, 0,10, 4, 4,20],
         [20,30, 4, 9, 0, 0, 0, 9, 9, 0, 0, 0, 9, 4,31,20],
         [20, 4, 4,10, 0, 0,29, 0, 0,29, 0, 0,10, 4, 4,20],
         [20,12,11,10, 0,29, 0,12, 0, 3,29, 0,10,11,12,20],
         [20, 3, 3,29, 0, 0, 0, 0, 0, 3, 1,29, 0, 0, 0,20],
         [20, 3,29, 3, 0, 0,27,19,19,28, 1, 2,29, 0, 0,20],
         [20, 2, 1,29, 3, 3, 1,11, 0, 0, 1, 2, 1,29, 0,20],
         [20, 2, 2, 1, 1, 3, 3,10, 0, 3, 3, 2, 1,11, 0,20],
         [23,19,19,19,19,19,19,19,19,19,19,19,19,19,19,22]
         ]
