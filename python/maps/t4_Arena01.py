...
def get_arena(path="", convert=False):
    ...
    arena = [ #size 15x15
         ...
         [20, 5, 6, 7, 9, 4, 2, 2, 1, 4, 9, 0, 0, 0,20],
         [20, 0,30, 8,10, 4, 1, 9, 2, 4,10, 0,31, 0,20],
         [20, 0, 0, 5, 6, 4, 1,29, 1, 4, 0, 0, 0, 0,20],
         [20, 9,10, 6,12, 4, 9, 1,29, 4,12, 0,10, 9,20],
         [20, 4, 4, 6, 4,29, 2, 1,10, 9, 4, 4, 4, 4,20],
         [20, 2, 2, 7,29, 2, 2,29, 2, 2,29, 2, 2, 2,20],
         [20, 2, 9,29, 8, 5,29, 2, 2,29, 0, 9,29, 2,20],
         [20, 2, 2, 2, 9,10, 6, 7,29, 2, 2, 2, 2, 2,20],
         [20, 4, 4, 4, 4,29, 1, 9, 8, 5, 6, 7, 4, 4,20],
         [20, 9,10, 0,12, 4,29, 2, 2, 4,12, 8,10, 9,20],
         [20, 0, 0, 0, 0, 4, 1,25, 1, 4, 0, 5, 0, 0,20],
         [20, 0,33, 0,10, 4, 1,26, 1, 4,10, 6,32, 0,20],
