##"Arena01.py" - The first arena I made for TBO
...
def get_arena(path=""):
    ...
    arena = [ #size 15x15
         ...
         [20, 0, 0, 0, 9, 0, 0,10, 0, 0, 9, 0, 0, 0,20],
         [20, 0,30, 0,10, 0, 0, 9, 0, 0,10, 0,31, 0,20],
         [20, 0, 0, 0,11, 0, 0,29, 0, 0,11, 0, 0, 0,20],
         [20, 9,10,11,12, 0, 9, 0,29, 0,12,11,10, 9,20],
         [20, 0, 0, 0, 0,29, 0, 0,10, 9, 0, 0, 0, 0,20],
         [20, 0, 0, 0,29, 0, 0,29, 0, 0,29, 0, 0, 0,20],
         [20,10, 9,29, 0, 0,29, 0, 0,29, 0, 9,29,10,20],
         [20, 0, 0, 0, 9,10, 0, 0,29, 0, 0, 0, 0, 0,20],
         [20, 0, 0, 0, 0,29, 0, 9, 0, 0, 0, 0, 0, 0,20],
         [20, 9,10,11,12, 0,29, 0, 0, 0,12,11,10, 9,20],
         [20, 0, 0, 0,11, 0, 0,25, 0, 0,11, 0, 0, 0,20],
         [20, 0,33, 0,10, 0, 0,26, 0, 0,10, 0,32, 0,20],
         [20, 0, 0, 0, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0,20],
