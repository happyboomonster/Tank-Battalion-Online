...
def get_arena(path=""):
    ...
    # - Define the arena -
    arena = [ #size 15x19
         [24,15,15,15,15,15,15,20,15,15,15,15,15,15,21],
         [17,14,14,14,14,14,18,30,29,14,14,14,14,14,18],
         [17,14,14,14,14,14,18, 4, 4,17,14,14,14,14,18],
         [17,14,14,14,14,14,22,11,11,17,14,14,14,14,18],
         [17,14,14,14,14,18, 4, 4, 4,23,14,14,14,14,18],
         [17,14,14,14,14,18, 4,10, 0, 0,17,14,14,14,18],
         [17,14,14,14,14,22, 4, 4,11, 0,17,14,14,14,18],
         [17,14,14,14,18, 0, 0,12, 3, 3,23,14,14,14,18],
         [17,14,14,14,18, 0, 9, 9, 9, 3, 3,17,14,14,18],
         [17,14,14,14,22, 2, 2, 2, 3, 9, 3,17,14,14,18],
         [17,14,14,18, 0,29, 3, 3, 3, 1, 3,23,14,14,18],
         [17,14,14,18, 0, 0,29, 3, 1, 1,29, 0,17,14,18],
         [17,14,14,22, 0, 0, 3, 9,11, 9, 2, 0,23,14,18],
         [17,14,18, 0, 0,25, 3,11,29,11, 1, 0, 4,17,18],
         [17,14,18, 0, 4,20, 2, 2,11, 0, 2,29, 4,17,18],
         [17,14,16,29, 4,20, 3, 2, 9, 0,25, 4, 4,17,18],
         [17,29, 4,11, 4,26, 4, 3,29, 0,26, 4,11,23,18],
         [20,32, 4,11, 4, 4, 4,25, 0, 0, 0, 4,11,31,20],
