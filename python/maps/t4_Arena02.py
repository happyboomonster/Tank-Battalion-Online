##"t4_Arena02.py" - The second arena I built for TBO
...
def get_arena(path="", convert=False):
    ...
    arena = [
         ...
         [20, 2, 2, 2,20, 2, 1,25, 0, 0, 2, 2, 2, 2,20],
         [20, 9,29, 2,26, 2, 3,20, 0, 0,27,19,19,19,18],
         ...
         [17,19,19,19,28, 2, 2,20, 0, 0,25, 2,29, 9,20],
         [20, 2, 2, 2, 2, 4, 4,26, 3, 0,20, 2, 2, 2,20],
